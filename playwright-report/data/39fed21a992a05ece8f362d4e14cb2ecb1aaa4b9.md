...
- generic [ref=e1]:
  ...
  - generic [ref=e35]:
    ...
    - generic [ref=e38]:
      - button "Show Autodismiss Notification" [active] [ref=e39] [cursor=pointer]
      - button "Show Dismissible Notification" [ref=e40] [cursor=pointer]
  - alert [ref=e43]:
    - generic [ref=e44]: This notification auto-dismisses in 5 seconds. Hover to pause.
    - button "Dismiss" [ref=e45]: ✕
```